...
LightSleepMin+DeepSleepMin as InBedMin,
DeepSleepMin,
LightSleepMin,
SleepStart,
SleepEnd,
...
||strftime(' %d, %Y',Date) as DateUS,"Daily Activity" as Activity,
strftime('%H',SleepStart) as BedHour,strftime('%M',SleepStart) as BedMinute,
strftime('%H',SleepEnd) as AwakeHour,strftime('%M',SleepEnd) as AwakeMinute,
